...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/old-voice-a09c)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/old-voice-a09c
```

A live public deployment of this template is available at [https://old-voice-a09c.templates.workers.dev](https://old-voice-a09c.templates.workers.dev)
